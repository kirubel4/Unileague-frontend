  ...
  async function handleDeleteTournament(id: string, name: string) {
    ...
    try {
      const res = await fetch(
        `/api/protected/admin/tournaments/delete?id=${id}`,
        { method: "DELETE" }
      );
      ...
      alert(result.data?.message || "Tournament deleted!");
      ...
      console.error(err);
      alert("Unexpected error deleting tournament");
    }
  }
                    ...
                    <td className="py-2 px-4">
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            handleDeleteTournament(t.id, t.tournamentName)
                          }
                        >
