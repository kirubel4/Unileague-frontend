...
export default function AdminNewsCreate() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.loading("Posting News", { id: "ww" });
    ...
    const res = await fetch("/api/protected/admin/news", {
      method: "POST",
      body: form,
    });
    const response: ApiResponse = await res.json();
    if (!response.success) {
      toast.error(response.message, { id: "ww" });
      setIsSubmitting(false);
      return;
    }
    toast.success("News Posted Successfully", { id: "ww" });
    setIsSubmitting(false);
